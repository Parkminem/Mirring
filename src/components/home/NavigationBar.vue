...
function goSection(num) {
  window.scrollTo({ top: document.querySelector(`.dot${num}`).offsetTop - 100, behavior: 'smooth' });
  if (num == 3) window.scrollTo({ top: document.querySelector(`.dot${num}`).offsetTop - 400, behavior: 'smooth' });
}
